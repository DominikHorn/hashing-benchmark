...
taskqueue_t *  taskqueue_init(int allocsize);

/** Add a new task to the front of the queue */
void taskqueue_addfront(taskqueue_t * tq, void * t);

/** Add a new task to the tail of the queue */
void taskqueue_addtail(taskqueue_t * tq, void * t);

/** get the task from the front of the queue */
void * taskqueue_getfront(taskqueue_t * tq);

/** get the task from the end of the queue */
void * taskqueue_gettail(taskqueue_t * tq);

void taskqueue_free(taskqueue_t * tq);

/* gets a new taskitem slot */
inline taskitem_t * taskqueue_getslot(taskqueue_t * tq);
